...
log_info ""
log_info "Next steps:"
log_info "1. Setup PLATFORM_DEPLOY_TOKEN for project repositories:"
log_info "   ./lib/setup-project-token.sh --all    # All projects"
log_info "   ./lib/setup-project-token.sh <name>   # Specific project"
